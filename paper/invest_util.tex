...
variances of the returns to the x and y portfolios and $\gamma$ is the investor risk aversion coefficient. %I multiply the gains by 12 to annualize them. 
All investor risk aversion coefficients from 1 to 5 are tested for investors subject to investment constraints from a limit of 1 to 3.% on the market portfolio, no leverage to 200\% leverage.
