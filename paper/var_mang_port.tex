...
\usepackage{float,lscape,adjustbox,array,subcaption,tabularx,physics}
\usepackage{hyperref}
...
\author{Jeramia Poland \thanks{\rm Indian School of Business, email \href{mailto:jeramia_poland@isb.edu}{jeramia\_poland@isb.edu}. Acknowledgments : I thank Prachi Deuskar, Nitin Kumar, Tarun Chordia, Omesh Kini, Amit Goyal}}

\title{\Large \bf How to Look Clever and Have Envious Neighbors: Average Volatility Managed Leverage Timing}
