...
\usepackage{float,lscape,adjustbox,array,subcaption,tabularx}
\usepackage{hyperref}
...
\section{Asset Allocation} \label{sec:asset_allocation}

\input{asset_allocation}

\subsection{Portfolio Performance} \label{port_performance}

\input{port_performance}

\subsection{Investor Utility} \label{invest_util}
