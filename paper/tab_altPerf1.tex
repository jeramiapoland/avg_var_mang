...
\begin{tabular}{@{\extracolsep{5pt}} Hccccccc} 
	& & \multicolumn{6}{c}{(a) Other Assets Managed by Equity AV} \\
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\hline \\[-1.8ex] 
& & \multicolumn{6}{c}{(b) Equity Managed by Other Assets AV} \\
& & \multicolumn{2}{c}{Currency} &\multicolumn{2}{c}{Bonds}& \multicolumn{2}{c}{BH}\\
\cline{3-4} \cline{5-6} \cline{7-8}\\
...
\hline \\[-1.8ex]
&\textit{Notes:} & \multicolumn{6}{r}{SV results are show for Bond$_{Univ}$ and  Curr$_{DB}$ return volatility.}\\
& & \multicolumn{6}{l}{Results for the other currency indices are similar.}
\end{tabular} 
\end{table} 
