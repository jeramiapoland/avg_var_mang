...
\begin{frame}{Central Idea I}
	\begin{itemize}[<+->]
		...
		%\item Zeroing in on AV manages the dynamic mix, limiting uncompensated risk without losing next months return (through AC)
...
\begin{frame}{Contribution}
		\onslide<+->{\begin{block}{Variance Management}
				...
				%	\item Moreira and Muir (2017) and Hocquard, Ng, and Papageorgiou (2013)
					\item AV is a better dynamic volatility management signal
...
\begin{frame}{Investment Weight Again Again}
	\begin{adjustbox}{width=\textwidth}
		\begin{tabular}{@{\extracolsep{5pt}}lcHccccccc} 
			\multicolumn{10}{c}{CRSP Market Portfolio Investment Weights}
			\\\hline 
			\hline \\[-1.8ex] 
...
\begin{frame}{Drawdown Insurance: Unconstrained }
...
\begin{frame}{Leverage and Returns}
	\begin{adjustbox}{width=\textwidth,height=.8\textheight}
		\input{figures/m_ret_plot2}
	\end{adjustbox}
\end{frame}
...
%	\begin{itemize}[<+->]
%		\item Check for performance across markets globally
%		\item Test the dependence of AC and AV on the relationship of index daily returns and aggregate wealth in US equity time series
%		\item Test the dependence of AV managed return performance on the relationship of daily returns and aggregate wealth - US time series and global cross section
%		\item Test the ability of AV calculated from equity returns to manage investment in other asset classes
%	\end{itemize}
	\begin{itemize}[<+->]
