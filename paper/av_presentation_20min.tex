...
%		\begin{itemize}[<+->]
%			\item In a subset where daily returns are unrepresentative, AC won't predict $r_{s,t+1}$, AV management won't perform
...
\begin{tabular}{@{\extracolsep{5pt}} Hccccccc}
	\\[-1.8ex]\hline\\
	\multicolumn{8}{c}{2005M7:2015M12} \\
	\hline \\[-1.8ex] 
	& & \multicolumn{2}{c}{AV} &\multicolumn{2}{c}{SV}& \multicolumn{2}{c}{BH}\\
...
\begin{frame}{Conclusion}
	\onslide<+->{\begin{block}{Variance Management}
		...
		\onslide<+->{\begin{block}{Risk Dynamics}
				\begin{itemize}[<+->]
					\item Gonzalez-Urteaga and Rubio (2016) and Bollerslev, Hood, Huss, and Pedersen (2017)
					\item AV comes from the foundations of investment risk
